var store = [{
        ...
        "excerpt":"발제자: 권혁선 발제일: 2024년 06월 05일 키워드: [AutoML] [ML resource provisioning] URL: https://ieeexplore.ieee.org/abstract/document/10437119 발표자료: PDF Why this paper Network operator가 효율적으로 ML(Machine Learning) Workflow를 구성할 수 있는 프레임워크(AutoMLPoweredNetworks)를 제시한다. 5G network로 부터 얻은 real operator data(ie. KPI)를 사용해 테스트를 진행하였다. Summary of paper 1. Introduction 5G 서비스 기반(Service-Based) 아키텍쳐 측면에서...","categories": [],
        "tags": [],
        "url": "/lab_meeting/3/",
        "teaser": null
      },{
    ...
    "title": "AutoMLPoweredNetworks: Automated Machine Learning Service Provisioning for NextGen Networks",
    "excerpt":"발제자: 3.md 발제일: 2024년 06월 05일 키워드: [AutoML] [ML resource provisioning] URL: https://ieeexplore.ieee.org/abstract/document/10437119 발표자료: PDF Why this paper Network operator가 효율적으로 ML(Machine Learning) Workflow를 구성할 수 있는 프레임워크(AutoMLPoweredNetworks)를 제시한다. 5G network로 부터 얻은 real operator data(ie. KPI)를 사용해 테스트를 진행하였다. Summary of paper 1. Introduction 5G 서비스 기반(Service-Based) 아키텍쳐 측면에서...","url": "http://localhost:4000/_lab_meeting/3/"
  },{
